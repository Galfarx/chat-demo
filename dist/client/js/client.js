	...
	_createClass(Client, [{
		...
		value: function setupEvents() {
			...
			this.startButton.onclick = function () {
				_this.startChat(_this.userName.value);
			};

			this.userName.addEventListener('keypress', function (e) {
		...
		key: 'validateNick',
		value: function validateNick(nick) {
    ...
    _createClass(Chat, [{
        ...
        value: function setupEvents() {
            ...
            this.chatInput.addEventListener('keypress', function (key) {
                ...
                if (key === 13) {
                    _this2.sendChat((0, _util.sanitizeString)(_this2.chatInput.value));
